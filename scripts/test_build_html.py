...
def run_photo_split_tests():
    ...
    assert len(show) == 6, f'Expected 6 displayed (capped at threshold), got {len(show)}'
    ...
    assert len(show2) == 6, f'Expected 6 displayed (capped at threshold), got {len(show2)}'
    assert len(extra2) == 4, f'Expected 4 extra, got {len(extra2)}'
