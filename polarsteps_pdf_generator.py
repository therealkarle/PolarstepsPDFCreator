...
class CombinedHtmlBuilder:
    ...
    def _build_html(self) -> str:
        ...
        html_parts = [
            ...
            '.step-marker-icon { border-radius: 50%; overflow: hidden; border: 2px solid rgba(255,255,255,0.9); box-shadow: 0 0 0 1px rgba(0,0,0,0.08); background: #fff; }',
            ...
            '        var iconHtml = "<div class=\\\"step-marker-icon\\\" style=\\\"width:36px;height:36px;border-color:" + color + ";\\\">" +',
            ...
            '      } else {',
            '        marker = L.circleMarker([step.lat, step.lon], { radius: 6, color: color, fillColor: color, fillOpacity: 0.9, weight: 1 });',
            '      }',
