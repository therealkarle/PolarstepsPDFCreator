...
class CombinedHtmlBuilder:
    ...
    def _build_html(self) -> str:
        ...
        html_parts = [
            ...
            '#trip-list { overflow-y:auto; max-height: calc(100vh - 220px); }',
            ...
            '.map-panel { display: grid; grid-template-rows: minmax(220px, 1fr) 8px minmax(220px, 1fr); gap: 0; height: calc(100vh - 136px); min-width: 0; }',
            ...
            '.details-panel { background:#fff; border-radius: 16px; padding: 16px; box-shadow: 0 2px 12px rgba(0,0,0,0.05); display:flex; flex-direction:column; overflow:hidden; min-height: 220px; max-height: calc(100vh - 196px); min-width: 0; }',
            ...
            '#selected-step-list { overflow-y:auto; max-height: calc(100vh - 310px); padding-right: 8px; }',
