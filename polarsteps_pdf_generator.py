...
class InteractiveHtmlBuilder:
    ...
    def _build_html(self) -> str:
        ...
        html_parts = [
            ...
            'var htmlMapStyle = ' + json.dumps(str(self.config.get("html_map_style", "hybrid")).lower().strip()) + ';',
            ...
            'var selectedLayer = hybridLayer;',
            'if (htmlMapStyle === "satellite") { selectedLayer = satelliteLayer; } else if (htmlMapStyle === "road" && htmlOsmAvailable) { selectedLayer = osmLayer; } else if (htmlMapStyle === "road") { selectedLayer = esriRoadLayer; }',
...
class CombinedHtmlBuilder:
    ...
    def _build_html(self) -> str:
        ...
        html_parts = [
            ...
            'var currentMapStyle = htmlMapStyle && mapStyleLayers[htmlMapStyle] ? htmlMapStyle : "hybrid";',
